...
img_paths_test = []
img_cuts = []
path_train = "./datasets/ShanghaiTech/part_A_final/train_data/images/"
path_test = "./datasets/ShanghaiTech/part_A_final/test_data/images/"
...
img_paths_test.sort()
# Prepare the inputs
save_path_train = './processed_datasets/SHA/train_data/'
save_path_test = './processed_datasets/SHA/test_data/'
...
f_count_train = open("./processed_datasets/SHA/train_data/data_list/train.txt", "w+")
f_count_test = open("./processed_datasets/SHA/test_data/data_list/test.txt", "w+")
